...
<body class="bg-light">
  ...
  <?php 
    ...
    // Check if rating_review table exists before querying it
    if(table_exists('rating_review')) {
      ...
      $unread_reviews = ['count' => 0]; // Default value if table doesn't exist
    }
  ...
  <?php
    $dashboard_js_path = 'scripts/dashboard.js';
...
window.onload = function() {
    ...
    user_analytics();
      ...
      file_put_contents($dashboard_js_path, $default_js);
    }
  ?>
